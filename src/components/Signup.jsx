...
const Signup = () => {
  ...
  return (
    <section className="rounded-md mx-3 lg:w-1/3 mt-10 lg:mx-auto bg-black/20 dark:bg-white/5 p-0.5">
      <div className="flex rounded-md items-center justify-center bg-white dark:bg-zinc-900 w-full px-4 py-5 sm:px-6 sm:py-8 lg:px-4">
